...
function selfTest() {
  ...
  console.log("emit self-test: five-field format, candidate statement, slug and register cases pass; "
    ...
    + "self-test GREEN and fails install-test's refusal case \u2014 which IS kogaki#509's mutation 1 "
    + "re-run at this head, NOT a ninth: it is counted once, in the tally below, and named here "
    + "only to locate the layer. Same two-layer split the RENDER SITE "
