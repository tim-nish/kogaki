...
echo "ok: retention fixture pass ran ${N} case(s) clean, exactly at its floor of ${FLOOR}; runs/README.md is the one tracked path and lane content is ignored"
exit 0
