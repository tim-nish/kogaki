...
// not).
{
  ...
  if (spec && skill) {
    ...
    // reference is named as one that "declares an optional Step field and the
    ...
    const marksRequired = (line) => /\*\*Required\.\*\*/.test(line);
...
console.log("brief compose: " + CASE_COUNT + "/" + CASE_COUNT + " cases — "
  ...
  + "clause 3 stands). "
  + "MUTATION EVIDENCE (assert-by-breaking-once, stories 1.73 + 1.75 + 1.77 + kogaki#501 + kogaki#520 + kogaki#551 + kogaki#568 + kogaki#574 + kogaki#578 + kogaki#642 + kogaki#859 + PR #863 round 2 + kogaki#893 + kogaki#877 + kogaki#934 + kogaki#935 + kogaki#942 + kogaki#966): FIFTY-FOUR "
  ...
  + "original groups, plus kogaki#568's four, plus PR #576 round 1's two, plus kogaki#574's two, plus kogaki#578's one, plus kogaki#642's one, plus kogaki#859's three, plus PR #863 round 2's three, plus kogaki#893's three, plus kogaki#934's three, plus kogaki#935's three, plus kogaki#942's five, plus kogaki#966's three = 54. "
